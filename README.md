...
Для отлаживания работы утилиты командной строки необходимо собрать образ в uv 

```bash
uv build
```

Затем установить его в pip из директории dist которая появляется после первого шага
