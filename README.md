...
- демонстрация примеров программ, которые посильны начинающим программистам ("если в МГИМО смогли написать такой код, я тоже смогу"),
- проведение тестов и обучающихих игр, 
- автоматизация прикладных аналитических задач, которые решают наши студенты и коллеги – с помощью уже существующих или новых инструментов.

К текущей версии наш пакет умеет:

- [x] конвертировать оценки в шкале МГИМО, 
- [x] проводить тест на знание столиц мира. 
...
Полная документация доступна по адресу: [https://mgimo-dd.github.io/py-mgimo](https://mgimo-dd.github.io/py-mgimo)

Документация включает:
- Подробные примеры использования API
- Описание всех функций и классов
- Руководство по установке
- Интерактивную документацию CLI

### Локальная сборка документации

Для локальной сборки и просмотра документации:
...
После запуска сервера документация будет доступна по адресу [http://127.0.0.1:8000](http://127.0.0.1:8000).
...
ruff check .
pytest
mkdocs build  # Собрать документацию
```
